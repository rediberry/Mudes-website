...
function saveContactInfo(name, lastName, email, message) {
...
class Contact{
	contactRef = db.collection("contactInfo");

	async add(name,lastName, email, message, date){
		const contact = {name, lastName, email, message, date};
